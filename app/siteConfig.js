...
export const siteConfig = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL || "https://www.grabtok.cc",
  ...
  twitter: "@grabtok",
  // 👇 Your contact details (used on About, Contact, Privacy, DMCA, Terms)
  email: "tayp.travel@gmail.com",
  whatsapp: "923176939169", // digits only, no + or spaces
};
